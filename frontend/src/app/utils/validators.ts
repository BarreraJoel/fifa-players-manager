            ...
            for (const key of errorKey) {
                switch (key) {
                    ...
                    case "pattern":
                        ...
                        break;
                    case "strongPassword":
                        const error = control.errors['strongPassword'];
                        ...
                        errorMessage =
                            !error.hasLowercase ||
                                ...
                                ? "El campo debe contener una letra minuscula, mayuscula, un numero y un caracter especial"
                                : "";
                        break;
                    case "minlength":
                    ...
                    case "equals":
                        ...
                        break;
                    case "backend":
                        errorMessage = control?.errors?.['backend'].message;
                        break;
